...
<script>
import AppAuth from './components/__tests__/AppAuth.vue'
import AppHeader from './components/__tests__/AppHeader.vue'

export default { components: { AppHeader, AppAuth } }
</script>
